      ...
      return new Promise((resolve) => { ///imitation of server`s request
         setTimeout(() => {
            let lessons = [
               ...
               { id: 4, name: 'Урок 5', amountOfExercises: '33', amountOfDoneExercises: '27', amountOfMistakes: '19', amountOfInaccuracies: '33', spentTime: '100', earnedTerricoins: '1000' },
               { id: 5, name: 'Урок 6', amountOfExercises: '23', amountOfDoneExercises: '19', amountOfMistakes: '19', amountOfInaccuracies: '33', spentTime: '100', earnedTerricoins: '1000' },
               { id: 6, name: 'Урок 7', amountOfExercises: '55', amountOfDoneExercises: '50', amountOfMistakes: '19', amountOfInaccuracies: '33', spentTime: '100', earnedTerricoins: '1000' },
               { id: 7, name: 'Урок 8', amountOfExercises: '95', amountOfDoneExercises: '10', amountOfMistakes: '19', amountOfInaccuracies: '33', spentTime: '100', earnedTerricoins: '1000' },
               { id: 8, name: 'Урок 9', amountOfExercises: '55', amountOfDoneExercises: '50', amountOfMistakes: '19', amountOfInaccuracies: '33', spentTime: '100', earnedTerricoins: '1000' },
               { id: 9, name: 'Урок 10', amountOfExercises: '95', amountOfDoneExercises: '10', amountOfMistakes: '19', amountOfInaccuracies: '33', spentTime: '100', earnedTerricoins: '1000' },
            ]
